...
public class ReplyController {
	...
	/**
	 * 댓글번호에 해당하는 댓글 내용 수정하기 update reply set content = ? where reply_no = ?
	 */
	...
	/**
	 * 댓글번호에 해당하는 댓글 삭제 delete from reply where reply_no = ?
	 */
	...
	/**
	 * 댓글 채택하기 update reply set selected_reply = ? where reply_no = ?
	 */
